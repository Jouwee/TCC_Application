...
public class SimulationParameters {
    ...
    public static SimulationParameters create() {
        ...
        parameters.put(1, new GenerationParameters(POP_SIZE, 0.1, 0.40, 0.005, 0.2));
        parameters.put(5, new GenerationParameters(POP_SIZE, 0.1, 0.40, 0.005, 0.2));
        parameters.put(10, new GenerationParameters(POP_SIZE, 0.1, 0.35, 0.01, 0.2));
        parameters.put(20, new GenerationParameters(POP_SIZE, 0.1, 0.30, 0.02, 0.2));
        parameters.put(30, new GenerationParameters(POP_SIZE, 0.1, 0.25, 0.03, 0.2));
        parameters.put(40, new GenerationParameters(POP_SIZE, 0.1, 0.20, 0.04, 0.2));
        parameters.put(50, new GenerationParameters(POP_SIZE, 0.1, 0.15, 0.05, 0.2));
        parameters.put(60, new GenerationParameters(POP_SIZE, 0.1, 0.10, 0.06, 0.2));
        parameters.put(99999, new GenerationParameters(POP_SIZE, 0.1, 0.05, 0.07, 0.2));
        return parameters;
    }
